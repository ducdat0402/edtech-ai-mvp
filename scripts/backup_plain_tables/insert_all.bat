@echo off
REM Script to insert all data in correct order for Windows
...
psql -U %DB_USER% -d %DB_NAME% -f table_content_items.sql
...
REM Level 4: 3 dependencies
psql -U %DB_USER% -d %DB_NAME% -f table_content_versions.sql
