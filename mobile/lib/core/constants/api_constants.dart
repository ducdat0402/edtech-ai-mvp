...
class ApiConstants {
  ...
  static String startLearningGoals(String subjectId) =>
      '/subjects/$subjectId/learning-goals/start';
  static String chatLearningGoals(String subjectId) =>
      '/subjects/$subjectId/learning-goals/chat';
  static String getLearningGoalsSession(String subjectId) =>
      '/subjects/$subjectId/learning-goals/session';
  static String generateSkillTreeWithGoals(String subjectId) =>
      '/subjects/$subjectId/learning-goals/generate-skill-tree';
  static String generateLearningNodesFromTopic(
          String subjectId, String topicNodeId) =>
      '/subjects/$subjectId/mind-map/$topicNodeId/generate-learning-nodes';
  static String getGenerationProgress(String subjectId, String taskId) =>
      '/subjects/$subjectId/generation-progress/$taskId';

  // Domains
  static String domainsBySubject(String subjectId) =>
      '/domains/subject/$subjectId';
  ...
  static String claimAchievementRewards(String userAchievementId) =>
      '/achievements/$userAchievementId/claim-rewards';
  ...
  static String subjectLeaderboard(String subjectId) =>
  ...
  static String startAdaptiveTest(String subjectId) =>
      '/adaptive-test/start/$subjectId';
  static String submitAdaptiveAnswer(String testId) =>
      '/adaptive-test/$testId/submit';
  static String getAdaptiveTestResult(String testId) =>
      '/adaptive-test/$testId/result';
  ...
  static String checkNodeAccess(String nodeId) =>
      '/unlock/check-access/$nodeId';
  ...
  static String getLessonDataByType(String nodeId, String lessonType) =>
      '/nodes/$nodeId/lesson/$lessonType';
  static String updateLessonContent(String nodeId) =>
      '/nodes/$nodeId/lesson-content';
  ...
  static String submitEndQuizForType(String nodeId, String lessonType) =>
      '/nodes/$nodeId/submit-quiz/$lessonType';
  ...
  static const String currentWeeklyPlan =
      '/self-leadership/weekly-plan/current';
  static const String submitSelfLeadershipCheckin = '/self-leadership/checkin';
  static const String currentWeeklyReview =
      '/self-leadership/weekly-review/current';

  // Lesson Type Contents
  static String lessonTypeContentsByNode(String nodeId) =>
      '/lesson-type-contents/node/$nodeId';
  static String lessonTypeContentByType(String nodeId, String lessonType) =>
      '/lesson-type-contents/node/$nodeId/$lessonType';
  static String lessonTypeHistory(String nodeId, String lessonType) =>
      '/lesson-type-contents/node/$nodeId/$lessonType/history';
  static String lessonTypeVersionDetail(String versionId) =>
      '/lesson-type-contents/history/$versionId';

  // Lesson Content Edit (via contributions)
  static const String createLessonContentEdit =
      '/pending-contributions/lesson-content-edit';

  // Progress - Lesson Types, Topics, Domains
  static const String completeLessonType = '/progress/complete-lesson-type';
  static String lessonTypeProgress(String nodeId) =>
      '/progress/lesson/$nodeId/types';
  ...
  // Personal Mind Map
  static String checkPersonalMindMap(String subjectId) =>
      '/personal-mind-map/check/$subjectId';
  static String getPersonalMindMap(String subjectId) =>
      '/personal-mind-map/$subjectId';
  static String createPersonalMindMap(String subjectId) =>
      '/personal-mind-map/$subjectId';
  static String updatePersonalMindMapNode(String subjectId, String nodeId) =>
      '/personal-mind-map/$subjectId/nodes/$nodeId';
  static String deletePersonalMindMap(String subjectId) =>
      '/personal-mind-map/$subjectId';

  // Personal Mind Map - Chat riêng cho từng môn học
  static String startPersonalMindMapChat(String subjectId) =>
      '/personal-mind-map/$subjectId/chat/start';
  static String personalMindMapChat(String subjectId) =>
      '/personal-mind-map/$subjectId/chat';
  static String getPersonalMindMapChatSession(String subjectId) =>
      '/personal-mind-map/$subjectId/chat/session';
  static String generatePersonalMindMapFromChat(String subjectId) =>
      '/personal-mind-map/$subjectId/chat/generate';
  static String resetPersonalMindMapChat(String subjectId) =>
      '/personal-mind-map/$subjectId/chat/reset';
  ...
  static const String createSubjectPromotion =
      '/pending-contributions/subject-promotion';
  static const String createDomainContribution =
      '/pending-contributions/domain';
  static const String createTopicContribution = '/pending-contributions/topic';
  static const String createLessonContribution =
      '/pending-contributions/lesson';
  static const String createEditContribution = '/pending-contributions/edit';
  static const String createDeleteContribution =
      '/pending-contributions/delete';
  static String pendingContributionDetail(String id) =>
      '/pending-contributions/$id';
  static String approvePendingContribution(String id) =>
      '/pending-contributions/$id/approve';
  static String rejectPendingContribution(String id) =>
      '/pending-contributions/$id/reject';
  ...
  static String acceptFriendRequest(String friendshipId) =>
      '/friends/accept/$friendshipId';
  static String rejectFriendRequest(String friendshipId) =>
      '/friends/reject/$friendshipId';
  static String cancelFriendRequest(String friendshipId) =>
      '/friends/cancel/$friendshipId';
  ...
  static String friendRelationship(String userId) =>
  ...
  static String communityStatusReact(String id) =>
      '/community/statuses/$id/react';
  static String communityStatusComments(String id) =>
      '/community/statuses/$id/comments';
