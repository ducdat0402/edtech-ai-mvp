...
class AppColors {
  ...
  static const Color bgSecondary = Color(0xFF1A1A1A);    // Cards, elevated surfaces
  static const Color bgTertiary = Color(0xFF252525);     // Hover states, active elements
  ...
  static const Color textSecondary = Color(0xFFA3A3A3);  // Subtitles, descriptions
  ...
  static List<Color> getLevelGradient(int level) {
    if (level <= 5) {
      return [levelNewbie, Color(0xFF059669)];
    } else if (level <= 10) {
      return [levelStudent, Color(0xFF0891B2)];
    } else if (level <= 20) {
      return [levelScholar, Color(0xFF4F46E5)];
    } else if (level <= 35) {
      return [levelExpert, Color(0xFF7C3AED)];
    } else if (level <= 50) {
      return [levelMaster, Color(0xFFD97706)];
    } else if (level <= 75) {
      return [levelLegend, Color(0xFFDC2626)];
    } else {
      return [levelProdigy, Color(0xFFF59E0B)];
    }
  }
}
