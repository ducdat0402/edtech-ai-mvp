...
class _WorldChatScreenState extends State<WorldChatScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Icon(Icons.chat_rounded, color: t.brand, size: 22),
            const SizedBox(width: 8),
            Text('Chat', style: AppTextStyles.h4.copyWith(color: t.textPrimary)),
        ...
        bottom: TabBar(
          ...
          tabs: const [
            ...
            Tab(text: 'Bạn bè', icon: Icon(Icons.groups_rounded, size: 20)),
          ],
        ),
      ),
      body: TabBarView(
  ...
  Widget _buildFriendsChatTab() {
    ...
    if (_conversations.isEmpty) {
      return const EmptyStateWidget(
        ...
        message:
            'Chỉ nhắn tin được với bạn bè. Kết bạn qua mục Cộng đồng trên thanh điều hướng.',
      );
    }
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      Icons.send_rounded,
                      color: _isSending ? t.textTertiary : t.textOnBrand,
                      size: 20,
                    ),
                  ),
                ),
  ...
  Color _getUserColor(String username) {
    final t = context.colors;
    final colors = [t.brand, t.info, t.error, t.warning, t.gold, t.success];
