        ...
        content: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.check_circle_outline, color: AppColors.orangeNeon, size: 48),
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Tạo Bài Học Mới', style: AppTextStyles.h3.copyWith(color: AppColors.textPrimary)),
        leading: IconButton(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: AppColors.orangeNeon.withAlpha(76)),
                      ),
                      child: Row(
                        children: [
                          Icon(Icons.article_outlined, color: AppColors.orangeNeon, size: 24),
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: AppTextStyles.labelMedium.copyWith(color: AppColors.orangeNeon, fontWeight: FontWeight.bold),
                                ),
                    ...
                    _buildTextField(
                      ...
                      validator: (v) {
                        if (v == null || v.trim().isEmpty) return 'Vui lòng nhập tên bài học';
            ...
            DropdownMenuItem<String?>(
              ...
              child: Row(
                children: [
                  ...
                  Flexible(
                    child: Text(
                      _existingLessons.isEmpty ? 'Đây là bài học đầu tiên' : 'Đặt ở vị trí đầu tiên',
                      style: AppTextStyles.bodyMedium.copyWith(
                        color: AppColors.textPrimary,
                        fontStyle: _existingLessons.isEmpty ? FontStyle.italic : FontStyle.normal,
                      ),
